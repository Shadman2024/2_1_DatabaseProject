    ...
    <Fragment>
      <div className={styles.container}>
        ...
        <div className={styles.topitem2}>
          <div className={styles.title2}>TOP ITEMS</div>
          <div className={styles.options2}>
            <div
              className={`${styles.optn2} ${timeFrame2 === 'Today' ? styles.active : ''}`}
              onClick={() => setTimeFrame2('Today')}
            >
              Today
            </div>
            <div
              className={`${styles.optn2} ${timeFrame2 === 'ThisWeek' ? styles.active : ''}`}
