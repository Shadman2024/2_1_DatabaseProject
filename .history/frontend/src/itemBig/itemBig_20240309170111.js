...
const ItemBig = () => {
    ...
    <div key={index} className={styles.review}>
        ...
        <div className={styles.voteButtons}>
            <button onClick={() => handleVote(review.review_id, 'upvote')}><FontAwesomeIcon icon={faThumbsUp} size="2xl" /> {review.upvotes}</button>
            <button onClick={() => handleVote(review.review_id, 'downvote')}><FontAwesomeIcon icon={faThumbsDown} size="2xl" /> { review.downvotes}</button>
        </div>
    </div>
