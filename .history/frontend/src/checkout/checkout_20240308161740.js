...
const Checkout = ({ setAuth }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const orderData = {
            user_id: 'user_id', // Assuming you have the user's ID stored somewhere, e.g., in the state, local storage, or context
...
<button type="submit" onClick={() => handleSubmit()} className={styles.animated_button}>Place Order</button>
        </div>
    );
};
